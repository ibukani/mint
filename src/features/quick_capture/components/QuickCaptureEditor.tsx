  ...
  return (
    ...
    >
      ...
      <footer className="quick-capture__editor-footer">
        <div className="quick-capture__editor-status">
          <span
        ...
        <div className="quick-capture__editor-actions">
          <div className="quick-capture__action-group">
            <button
              type="button"
          ...
          <div className="quick-capture__action-group quick-capture__action-group--primary">
